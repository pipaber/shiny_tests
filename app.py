...
models = {
    ...
    "google": ["gemini-1.5-pro-latest","gemini-1.5-flash"],
}
...
with ui.sidebar(position="right"):
    ...
    ui.input_action_button("show", "Show datetime")
...
def chat_ui():
    ...
    if input.model() in models["openai"]:
        ...
        llm = ChatGoogleGenerativeAI(model=input.model())
    else:
